...
const variables = {
  ...
  SYNAPSE_REGISTRATION_SHARED_SECRET: getEnv("SYNAPSE_REGISTRATION_SHARED_SECRET"),
  ...
  MATRIX_BOT_SENDER_LOCALPART: getEnv("MATRIX_BOT_SENDER_LOCALPART"),
  MATRIX_BOT_NAMESPACE_USERS_REGEX: getEnv("MATRIX_BOT_NAMESPACE_USERS_REGEX"),
  MATRIX_BOT_NAMESPACE_ROOMS_REGEX: getEnv("MATRIX_BOT_NAMESPACE_ROOMS_REGEX"),
  MATRIX_BOT_NAMESPACE_ALIASES_REGEX: getEnv("MATRIX_BOT_NAMESPACE_ALIASES_REGEX"),
};
