...
const variables = {
  ...
  // AUTHENTIK_FQDN: getEnv("AUTHENTIK_FQDN"),
  // AUTHENTIK_CLIENT_ID: getEnv("AUTHENTIK_CLIENT_ID"),
  // AUTHENTIK_CLIENT_SECRET: getEnv("AUTHENTIK_CLIENT_SECRET"),
  // AUTHENTIK_UPSTREAM_OAUTH_PROVIDER_ID: getEnv("AUTHENTIK_UPSTREAM_OAUTH_PROVIDER_ID"),
};
...
const templates = [
  ...
  {
    templateFile: "./configurations/nginx/client/template.client.well-known.html",
    // to be mounted in container
    // html/.well-known/matrix/client/index.html
    outFile: "./configurations/nginx/client/index.html",
  },
  {
    templateFile: "./configurations/nginx/server/template.server.well-known.html",
    // to be mounted in container
    // html/.well-known/matrix/server/index.html
